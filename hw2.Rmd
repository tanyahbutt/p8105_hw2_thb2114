...
The dataset "unemployment" contains `r nrow(unemployment_df)` observations for `r ncol(unemployment_df)` variables related to the Standard and Poor's (S&P) stock market index. The years included range from 1950 to 2015. The variable names in this dataset include: `r names(unemployment_df)`.
